<x-layouts.admin title="Add Rank">
    @if($errors->any())
    ...
    <form method="POST" action="{{ route('admin.ranks.store') }}" style="max-width:440px;">
        @csrf
        @include('admin.ranks._form', ['games' => $games, 'selectedGame' => $selectedGame])
        <div style="display:flex; gap:8px; margin-top:20px;">
            <button type="submit" class="hlx-btn-gold">Create</button>
            <a href="{{ route('admin.ranks.index', ['game' => $selectedGame]) }}" class="hlx-btn-green">Cancel</a>
        </div>
    </form>
</x-layouts.admin>
