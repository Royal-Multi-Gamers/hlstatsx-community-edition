<x-layouts.admin title="Add Ribbon">
    ...
    <form method="POST" action="{{ route('admin.ribbons.store') }}" style="max-width:500px;">
        @csrf
        @include('admin.ribbons._form', ['games' => $games, 'selectedGame' => $selectedGame])
        <div style="display:flex; gap:8px; margin-top:20px;">
            <button type="submit" class="hlx-btn-gold">Create</button>
            <a href="{{ route('admin.ribbons.index', ['game' => $selectedGame]) }}" class="hlx-btn-green">Cancel</a>
        </div>
    </form>
</x-layouts.admin>
