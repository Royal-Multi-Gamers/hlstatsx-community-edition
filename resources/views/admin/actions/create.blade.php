<x-layouts.admin title="Add Action">
    ...
    <form method="POST" action="{{ route('admin.actions.store') }}" style="max-width:520px;">
        @csrf
        @include('admin.actions._form', ['games' => $games, 'selectedGame' => $selectedGame])
        <div style="display:flex; gap:8px; margin-top:20px;">
            <button type="submit" class="hlx-btn-gold">Create</button>
            <a href="{{ route('admin.actions.index', ['game' => $selectedGame]) }}" class="hlx-btn-green">Cancel</a>
        </div>
    </form>
</x-layouts.admin>
